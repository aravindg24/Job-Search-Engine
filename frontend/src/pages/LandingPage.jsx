    ...
    <div style={{ backgroundColor: 'var(--bg)', color: 'var(--text)' }}>
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="font-serif text-5xl md:text-6xl leading-tight mb-6 text-[var(--text)]">
      ...
      <section className="px-6 md:px-16 py-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="font-serif text-3xl md:text-4xl mb-5 text-[var(--text)]">
      ...
      <section className="px-6 md:px-16 py-24 text-center max-w-7xl mx-auto">
        <div className="relative rounded-3xl p-16 overflow-hidden"
          ...
          <h2 className="font-serif text-4xl md:text-5xl mb-3 relative z-10 text-[var(--text)]">
